...
export default function StudentDashboard() {
  ...
  return (
    <main className="min-h-screen flex bg-gradient-to-br from-gray-100 to-blue-50">
      {/* Sidebar */}
      <aside className="w-64 bg-white/90 backdrop-blur-md border-r border-gray-200 shadow-lg p-6">
        <h2 className="text-2xl font-bold mb-8 text-blue-700">Student Panel</h2>
      ...
      <section className="flex-1 p-12">
        <h1 className="text-4xl font-bold text-blue-700 mb-10">
          Welcome Odia IT Students Dashboard
        </h1>
